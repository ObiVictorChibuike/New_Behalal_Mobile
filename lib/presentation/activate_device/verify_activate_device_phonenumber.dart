...
import 'package:behalal/presentation/activate_device/answer_security_questions.dart';
...
class VerifyActivateDevicePhoneNumber extends StatefulWidget {
  const VerifyActivateDevicePhoneNumber({super.key});

  @override
  State<VerifyActivateDevicePhoneNumber> createState() => _VerifyActivateDevicePhoneNumberState();
}

class _VerifyActivateDevicePhoneNumberState extends State<VerifyActivateDevicePhoneNumber> {
          ...
          children: [
            ...
            FadeInUp(
              ...
              child: Align(
                alignment: Alignment.centerLeft,
                child: Text(
                  'We have sent a 6 digit code to +234907687654. Kindly enter the code below to verify your phone number',
                        ...
                        child: SizedBox(
                          ...
                          child: AppButton(
                            ...
                            onPressed: () async {
                              ...
                              Navigator.push(context, MaterialPageRoute(builder: (context)=> const AnswerSecurityQuestions()));
