...
class GetAirtimeBillersByIdResponseModel {
  Data? data;
  String? message;

  GetAirtimeBillersByIdResponseModel({
    this.data,
    this.message,
  });

  factory GetAirtimeBillersByIdResponseModel.fromJson(Map<String, dynamic> json) => GetAirtimeBillersByIdResponseModel(
