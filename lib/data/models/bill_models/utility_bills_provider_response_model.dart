...
class UtilityBillsProviderResponseModel {
  Data? data;
  String? message;

  UtilityBillsProviderResponseModel({
    this.data,
    this.message,
  });

  factory UtilityBillsProviderResponseModel.fromJson(Map<String, dynamic> json) => UtilityBillsProviderResponseModel(
