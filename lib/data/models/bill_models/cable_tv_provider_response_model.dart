...
class CableTvProviderResponseModel {
  Data? data;
  String? message;

  CableTvProviderResponseModel({
    this.data,
    this.message,
  });

  factory CableTvProviderResponseModel.fromJson(Map<String, dynamic> json) => CableTvProviderResponseModel(
