...
class GetElectricityProvidersResponseModel {
  Data? data;
  String? message;

  GetElectricityProvidersResponseModel({
    this.data,
    this.message,
  });

  factory GetElectricityProvidersResponseModel.fromJson(Map<String, dynamic> json) => GetElectricityProvidersResponseModel(
